...
class AddFav extends React.Component<{}, AddFavState> {
    ...
    render() {
        ...
        return (
            <div>
                <div className={styles.addFavTitle}>添加收藏</div>
                <div className={styles.addFavBody}>
                    <div className={styles.trDiv}>
                        <div className={styles.tdDiv}>标题：</div>
                    ...
                    <div className={styles.trDiv}>
                        <div className={styles.tdDiv}>组：</div>
                        <div className={styles.tdDiv}>
                    ...
                    {!this.state.group &&
                        <div className={styles.trDiv}>
                            <div className={styles.tdDiv}>组名：</div>
                            <div className={styles.tdDiv}>
                                <input
                                    type="text"
                ...
                <div className={styles.addFavButtonRow}>
