...
function calcRect(obj: HTMLElement, stopElement?: HTMLElement): Rect {
    ...
    let offsetParent = (obj.offsetParent && obj.offsetParent != stopElement) ? obj.offsetParent as HTMLElement : null;
...
class DragAndDropManager {
    ...
    startDrag(
        ...
        this.rect = calcRect(ReactDOM.findDOMNode(this.draggingElement) as HTMLElement, this.handler.getOffsetRoot());
    ...
    private onMouseMove = (ev: MouseEvent) => ReactDOM.unstable_batchedUpdates(() => {
        ...
        for (let i = 0; i < this.targets.length; i++) {
            ...
            if (ev.pageX >= elementRect.left &&
                ...
                for (let child = targetDiv.firstChild as HTMLElement;
                    child;
    ...
    private onMouseUp = (ev: MouseEvent) => ReactDOM.unstable_batchedUpdates(() => {
